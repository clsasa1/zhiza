...
const TAG_LABELS: Record<string, string> = {
  ...
  'status:contract_soldier': 'Контрактная служба',
  'status:contract_decided': 'Решение по контракту',
  'status:defense_reserved': 'Бронь оборонного предприятия',
  'status:ai_choice_done': 'Решение перед лицом ИИ',
  'status:grandchildren_summer_done': 'Каникулы с внуками',
  'status:dacha_sale_decided': 'Решение по даче',
  'status:daughter_helped': 'Помощь дочери',
  'status:disabled': 'Инвалидность',
  'trait:ptsd': 'Тяжёлый ПТСР',
  'status:veteran': 'Ветеран',
  'status:served_contract': 'Контракт завершён',
  'status:pyet': 'Пьёт',
